...
export const beers: ItemModel[] = [
  {
    ...
    'ingredients': {
      'malt': [{'name': 'Maris Otter Extra Pale', 'amount': {'value': 3.3, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
    ...
    'ingredients': {
      'malt': [{'name': 'Maris Otter Extra Pale', 'amount': {'value': 3.25, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
        'amount': {'value': 0.2, 'unit': 'kilograms'}
      }, {'name': 'Munich', 'amount': {'value': 0.4, 'unit': 'kilograms'}}],
    ...
    'boil_volume': {'value': 25, 'unit': 'litres'},
    'method': {
      'mash_temp': [{'temp': {'value': 60, 'unit': 'celsius'}, 'duration': 10}, {
        'temp': {'value': 65, 'unit': 'celsius'},
        'duration': 30
      }, {'temp': {'value': 72, 'unit': 'celsius'}, 'duration': 10}, {'temp': {'value': 78, 'unit': 'celsius'}, 'duration': 5}],
    ...
    'ingredients': {
      'malt': [{'name': 'Propino Pale Malt', 'amount': {'value': 1.63, 'unit': 'kilograms'}}, {
        'name': 'Wheat Malt',
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 4.58, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
    ...
    'ingredients': {
      'malt': [{'name': 'Lager Malt', 'amount': {'value': 6.63, 'unit': 'kilograms'}}, {
        'name': 'Wheat',
        'amount': {'value': 0.38, 'unit': 'kilograms'}
      }],
      'hops': [{'name': 'Saaz', 'amount': {'value': 60, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Saaz',
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 3.63, 'unit': 'kilograms'}}, {
        'name': 'Munich',
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 9.69, 'unit': 'kilograms'}}, {
        'name': 'Chocolate',
        'amount': {'value': 0.19, 'unit': 'kilograms'}
      }, {'name': 'Carafa Special Malt Type 3', 'amount': {'value': 0.44, 'unit': 'kilograms'}}],
      'hops': [{'name': 'Tomahawk', 'amount': {'value': 31.25, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Magnum',
        'amount': {'value': 12.5, 'unit': 'grams'},
        'add': 'start',
        'attribute': 'bitter'
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 3.33, 'unit': 'kilograms'}}, {
        'name': 'Munich',
        'amount': {'value': 0.42, 'unit': 'kilograms'}
      }, {'name': 'Caramalt', 'amount': {'value': 0.28, 'unit': 'kilograms'}}, {
        'name': 'Acidulated Malt',
        'amount': {'value': 0.07, 'unit': 'kilograms'}
      }],
      'hops': [{'name': 'Magnum', 'amount': {'value': 7.5, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Magnum',
        'amount': {'value': 5, 'unit': 'grams'},
        'add': 'middle',
        'attribute': 'flavour'
    ...
    'ingredients': {
      'malt': [{'name': 'Munich', 'amount': {'value': 5.63, 'unit': 'kilograms'}}, {
        'name': 'Flaked Oats',
      ...
      'hops': [{'name': 'Saaz', 'amount': {'value': 25, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'First Gold',
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 6.38, 'unit': 'kilograms'}}, {
        'name': 'Crystal 150',
        'amount': {'value': 0.13, 'unit': 'kilograms'}
    ...
    'ingredients': {
      ...
      'hops': [{'name': 'First Gold', 'amount': {'value': 25, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Fuggles',
        'amount': {'value': 25, 'unit': 'grams'},
        'add': 'start',
        'attribute': 'bitter'
    ...
    'ingredients': {
      'malt': [{'name': 'Pale Ale', 'amount': {'value': 3.13, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
        'amount': {'value': 0.25, 'unit': 'kilograms'}
      ...
      'hops': [{'name': 'Simcoe', 'amount': {'value': 12.5, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Simcoe',
    ...
    'ingredients': {
      'malt': [{'name': 'Maris Otter Extra Pale', 'amount': {'value': 3.44, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
        'amount': {'value': 0.63, 'unit': 'kilograms'}
      ...
      'hops': [{'name': 'Cascade', 'amount': {'value': 43.8, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Cascade',
    ...
    'ingredients': {
      'malt': [{'name': 'Maris Otter Extra Pale', 'amount': {'value': 2.5, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
        'amount': {'value': 1.25, 'unit': 'kilograms'}
    ...
    'ingredients': {
      'malt': [{'name': 'Pale Ale - Tipple', 'amount': {'value': 11.1, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale - Spring Blend', 'amount': {'value': 5, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
        'amount': {'value': 1.25, 'unit': 'kilograms'}
      ...
      'hops': [{'name': 'Columbus', 'amount': {'value': 31.25, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Columbus',
        'amount': {'value': 25, 'unit': 'grams'},
        'add': 'end',
        'attribute': 'bitter'
    ...
    'ingredients': {
      'malt': [{'name': 'Pale Ale', 'amount': {'value': 6.13, 'unit': 'kilograms'}}, {
        'name': 'Crystal 150',
        'amount': {'value': 0.25, 'unit': 'kilograms'}
      ...
      'hops': [{'name': 'Hop Extract', 'amount': {'value': 20, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Amarillo',
        'amount': {'value': 25, 'unit': 'grams'},
        'add': 'start',
        'attribute': 'bitter'
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 5.06, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
        'amount': {'value': 0.25, 'unit': 'kilograms'}
      }, {'name': 'Dark Crystal', 'amount': {'value': 0.06, 'unit': 'kilograms'}}],
      'hops': [{'name': 'Cascade', 'amount': {'value': 2.5, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Centennial',
        'amount': {'value': 12.5, 'unit': 'grams'},
        'add': 'middle',
        'attribute': 'flavour'
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 6.12, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
        'amount': {'value': 0.8, 'unit': 'kilograms'}
      }],
      'hops': [{'name': 'Tomahawk', 'amount': {'value': 7, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Motueka',
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 5.63, 'unit': 'kilograms'}}, {
        'name': 'Wheat',
        'amount': {'value': 0.69, 'unit': 'kilograms'}
      }, {'name': 'Crystal', 'amount': {'value': 0.63, 'unit': 'kilograms'}}],
      'hops': [{
        'name': 'Columbus',
        'amount': {'value': 12.5, 'unit': 'grams'},
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 2.69, 'unit': 'kilograms'}}, {
        'name': 'Wheat',
        'amount': {'value': 1.25, 'unit': 'kilograms'}
      }, {'name': 'Caramalt', 'amount': {'value': 0.38, 'unit': 'kilograms'}}],
      'hops': [{'name': 'Waimea', 'amount': {'value': 2.5, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Amarillo',
        'amount': {'value': 2.5, 'unit': 'grams'},
        'add': 'middle',
        'attribute': 'flavour'
    ...
    'ingredients': {
      'malt': [{'name': 'Extra Pale', 'amount': {'value': 10, 'unit': 'kilograms'}}, {
        'name': 'Caramalt',
        'amount': {'value': 1.88, 'unit': 'kilograms'}
    ...
    'ingredients': {
      ...
      'hops': [{'name': 'Ahtanum', 'amount': {'value': 17.5, 'unit': 'grams'}, 'add': 'start', 'attribute': 'bitter'}, {
        'name': 'Chinook',
        'amount': {'value': 15, 'unit': 'grams'},
        'add': 'start',
        'attribute': 'bitter'
    ...
    'ingredients': {
      'malt': [{'name': 'Wheat', 'amount': {'value': 2.5, 'unit': 'kilograms'}}, {
        'name': 'Extra Pale',
        'amount': {'value': 2.06, 'unit': 'kilograms'}
      }],
      'hops': [{
        'name': 'First Gold',
        'amount': {'value': 18.75, 'unit': 'grams'},
